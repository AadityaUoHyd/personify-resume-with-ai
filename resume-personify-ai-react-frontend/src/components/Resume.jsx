...
import { FaGithub, FaLinkedin, FaPhone, FaEnvelope, FaPrint } from "react-icons/fa";
    ...
    <>
      ...
      <section className="flex justify-center mt-4">
        <button
          ...
          className="btn flex  items-center gap-4 text-white font-bold px-6 py-3 rounded-lg bg-gradient-to-r from-green-500 via-green-700 to-green-900 transition-all duration-300 ease-in-out hover:brightness-110 hover:scale-105"
        >
          <FaPrint />
          Print
        </button>
